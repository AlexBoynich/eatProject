<template>
     <div class="container">
      <div class="arrow_left"><img src="/img/slider/arrow.svg" alt="lastSlide" class="arrow"></div>
        <swiper  :cleanup-styles-on-destroy="false" ref="mySwiper" :options="swiperOptions" class="swiper">
          ...
          >
          <div class="card">
            <img class="sliderItemImg1" :src=sliderItem.link1 alt="Image">
            <h3 class="name1"> {{ sliderItem.second_name1 }} {{ sliderItem.name1 }}</h3>
            <p class="post1">{{ sliderItem.post1 }}</p>
          </div>
          <div class="card">
            <img class="sliderItemImg2" :src=sliderItem.link2 alt="Image">
      ...
      <div class="arrow_right"><img src="/img/slider/arrow.svg" alt="NextSlide" class="arrow"></div>
    </div>
  </template>
