<template>
    <div class="sponcorsBlock">
        <img src="/img/sponcors/titleSponcors.svg" alt="Title" class="title">
        <div class="container">
            <div class="arrow_left_sponcors"><img src="/img/slider/arrow.svg" alt="LastSlide" class="arrow"></div>
                <swiper :cleanup-styles-on-destroy="false" ref="mySwiper" :options="swiperOptions" class="swiper">
                    <swiper-slide
                    v-for="sliderItem in sponcorsList"
                    class="sliderItem"
                    >   
                        <a v-if="sliderItem.link1" :href="sliderItem.link1"><img class="sliderItemImg1" :src=sliderItem.logo1 alt="Image" ></a>
                        <a v-if="sliderItem.link2" :href="sliderItem.link2"><img class="sliderItemImg2" :src=sliderItem.logo2 alt="Image"></a>
                    </swiper-slide>
                    <div class="swiper-pagination" slot="pagination"></div>
                </swiper>
                <div class="arrow_right_sponcors"><img src="/img/slider/arrow.svg" alt="NextSlide" class="arrow"></div>
            </div>
        </div>
 </template>
