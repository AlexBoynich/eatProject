  ...
  <div>
    <div class="overlay" :class="{'active': menuIsShow}"></div>
      <ul :class="{'active': menuIsShow}"
          >
            ...
            <li @click="toggleMenu(); replace('https://vk.com/festival_est')"><a :href="vk"><img src="/img/header/vkLogoBlack.svg" alt="" class="vkLogoMobile"></a></li>
    </ul>
    <div class="container header">
      <header class="header"  :class="{backgroundNone: menuIsShow}">
        ...
        <img src="/img/header/vkLogo.svg" alt="" class="vkLogo" @click="replace(vk)">
        ...
        <div class="mobile background">
          ...
          <img :src="letoLogo" alt="" :class="{displayNone: menuIsShow}" class="letoLogoMobile" @click="replace(letoLink)">
          <img :src="`/img/header/${menuIsShow ? 'burgerClose' : 'burger'}.svg`"  alt="" :class="{'active burger': !menuIsShow, 'closeBurger' : menuIsShow}" @click="toggleMenu()">
        </div>
      </header>
    </div>
  </div>
