<template>
    <div class="favouriteBlock">
        <img src="/img/favouriteRestaurants/titleFavourites.svg" alt="" class="title">
        <div class="container">
            <div class="arrow_left_favourite"><img src="/img/slider/arrow.svg" alt="" class="arrow"></div>
                <swiper :cleanup-styles-on-destroy="false" ref="mySwiper" :options="swiperOptions">
                    <swiper-slide
                    v-for="sliderItem in sliderList"
                    class="sliderItem"
                    >   
                        <a :href="sliderItem.link1"><img class="sliderItemImg1" :src=sliderItem.logo1 alt=""></a>
                        <a :href="sliderItem.link2"><img class="sliderItemImg2" :src=sliderItem.logo2 alt=""></a>
                    </swiper-slide>
                    <div class="swiper-pagination" slot="pagination"></div>
                </swiper>
                <div class="arrow_right_favourite"><img src="/img/slider/arrow.svg" alt="" class="arrow"></div>
            </div>
        </div>
 </template>
 ...
 <script>
   ...
   export default {
     ...
     mounted() {
      axios
      .get('https://festival-edy-dev.tomsk-it.ru/api/participants')
      .then( (favourites) => {
