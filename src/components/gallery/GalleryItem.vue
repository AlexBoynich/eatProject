<template>
    <div class="galleryItemBlock">
        ...
        <div class="yearAlbum">
            <div class="arrow_left_gallery"><img src='/img/slider/arrow.svg' alt="" class="arrow"></div>
            <Swiper  :cleanup-styles-on-destroy="false"  :options="swiperOptions" class="swiper">
                <SwiperSlide v-for="(sliderItem, index) in galleryItem.list" :options="swiperOptions" class="swiperSlide">
                    <img :src=sliderItem.link1 alt="" :id="index" class="sliderImg" @click="openModalSlider(sliderItem.link1);">
                    <img :src=sliderItem.link2 alt="" class="sliderImg" @click="openModalSlider(sliderItem.link2);">
                </SwiperSlide>
                <div class="swiper-pagination" slot="pagination"></div>
            </Swiper>
            <div class="arrow_right_gallery"><img src='/img/slider/arrow.svg' alt="" class="arrow"></div>
        </div>
    </div>
</template>
