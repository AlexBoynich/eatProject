<template>
    <div class="galleryModalBlock">
        ...
        <div class="yearAlbum">
            <div class="arrow_left_modal"><img src=/img/gallery/arrowLeft.svg alt="" class="arrow"></div>
            ...
            <div class="arrow_right_modal"><img src=/img/gallery/arrowRight.svg alt="" class="arrow"></div>
        </div>
    </div>
</template>
