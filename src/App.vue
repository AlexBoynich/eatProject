...
export default {
  ...
  mounted() {
      ...
      axios
      .get('https://festival-edy-dev.tomsk-it.ru/api/info/header')
      .then( (date) => {
      ...
      axios
      .get('https://festival-edy-dev.tomsk-it.ru/api/info/place')
      .then( (place) => {
        this.place=place.data.info.title
        this.adress=place.data.info.text
      }),
      axios
      .get('https://festival-edy-dev.tomsk-it.ru/api/info/vk_link')
      .then( (vk) => {
