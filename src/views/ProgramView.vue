<template>
    <div class="program container">
        <img src="/img/program/title.svg" alt="" class="title">
...
<script>
  ...
  export default {
    ...
    mounted() {
      // Забираю даты
      axios
      .get('https://festival-edy-dev.tomsk-it.ru/api/dates')
      .then( (date) => {
      ...
      // Забираю ивент типы
      axios
      .get('https://festival-edy-dev.tomsk-it.ru/api/event_types')
      .then( (date) => {
      ...
      axios
      .get('https://festival-edy-dev.tomsk-it.ru/api/events/')
      .then( (events) => {
      ...
      axios
      .get('https://festival-edy-dev.tomsk-it.ru/api/info/festMap')
      .then( (map) => {
